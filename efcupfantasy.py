...
PLAYERS = [
    {"id": 1, "name": "ROJIT SHRESTHA", "price": 13,
        "position": "GK", "realTeam": "JOSHI JAGUARS", },
    {"id": 2, "name": "SUJAN BK", "price": 15,
        "position": "GK", "realTeam": "SOTI SOLDIERS"},
    {"id": 3, "name": "PRASHANNA PAUDEL", "price": 15,
        "position": "GK", "realTeam": "ACHARYA ATTACKERS"},
    {"id": 4, "name": "TANISHK THAPA", "price": 11,
        "position": "GK", "realTeam": "ZENITH ZEBRAS"},
    {"id": 5, "name": "AAYUSH ROKA", "price": 14,
        "position": "GK", "realTeam": "BENZE BULLS"},
    {"id": 6, "name": "SANGAM SHRESTHA", "price": 10,
        "position": "GK", "realTeam": "GODAR GOATS"},
    {"id": 7, "name": "SABIN DAHAL", "price": 5,
        "position": "FWD", "realTeam": "BENZE BULLS"},
    {"id": 8, "name": "SACHIN SEN", "price": 17,
        "position": "FWD", "realTeam": "ZENITH ZEBRAS"},
    {"id": 9, "name": "SAKAR SUBEDI", "price": 7,
        "position": "FWD", "realTeam": "BENZE BULLS"},
    {"id": 10, "name": "SANDIL KATUWAL", "price": 4,
        "position": "FWD", "realTeam": "GODAR GOATS"},
    {"id": 11, "name": "SANJAYA ADHIKARI", "price": 4,
        "position": "FWD", "realTeam": "ACHARYA ATTACKERS"},
    {"id": 12, "name": "SANKALPA SHARMA", "price": 11,
        "position": "FWD", "realTeam": "JOSHI JAGUARS"},
    {"id": 13, "name": "SHRIJAN BHUSAL", "price": 15,
        "position": "FWD", "realTeam": "ZENITH ZEBRAS"},
    {"id": 14, "name": "SHUBHAM SINGH", "price": 12,
        "position": "FWD", "realTeam": "GODAR GOATS"},
    {"id": 15, "name": "SHUSHANT ADHIKARI", "price": 11,
        "position": "FWD", "realTeam": "JOSHI JAGUARS"},
    {"id": 16, "name": "SHYAM MAHATO", "price": 8,
        "position": "FWD", "realTeam": "GODAR GOATS"},
    {"id": 17, "name": "SUDIP BARAL", "price": 18,
        "position": "FWD", "realTeam": "BENZE BULLS"},
    {"id": 18, "name": "SUJIT GURUNG", "price": 10,
        "position": "FWD", "realTeam": "ZENITH ZEBRAS"},
    {"id": 19, "name": "SUMAN CHHETRI", "price": 15,
        "position": "FWD", "realTeam": "SOTI SOLDIERS"},
    {"id": 20, "name": "UNIQUE REGMI", "price": 6,
        "position": "FWD", "realTeam": "SOTI SOLDIERS"},
    {"id": 21, "name": "SUMAN SHARMA", "price": 5,
        "position": "FWD", "realTeam": "SOTI SOLDIERS"},
    {"id": 22, "name": "UDHAY THAKUR", "price": 9,
        "position": "FWD", "realTeam": "GODAR GOATS"},
    {"id": 23, "name": "SAJAN ROKAYA", "price": 4,
        "position": "DEF", "realTeam": "ZENITH ZEBRAS"},
    {"id": 24, "name": "SAMEER ACHARYA", "price": 18,
        "position": "DEF", "realTeam": "ACHARYA ATTACKERS"},
    {"id": 25, "name": "SAMIR GODAR", "price": 18,
        "position": "DEF", "realTeam": "GODAR GOATS"},
    {"id": 26, "name": "SANTOSH JOSHI", "price": 18,
        "position": "DEF", "realTeam": "JOSHI JAGUARS"},
    {"id": 27, "name": "SUJAL PARAJULI", "price": 17,
        "position": "DEF", "realTeam": "JOSHI JAGUARS"},
    {"id": 28, "name": "SUJAL SOTI", "price": 18,
        "position": "DEF", "realTeam": "SOTI SOLDIERS"},
    {"id": 29, "name": "SUJAN BHAATTA", "price": 10,
        "position": "DEF", "realTeam": "SOTI SOLDIERS"},
    {"id": 30, "name": "SUSHAN PANDEY", "price": 7,
        "position": "DEF", "realTeam": "ACHARYA ATTACKERS"},
    {"id": 31, "name": "SWORNIM TIMILSINA", "price": 13,
        "position": "DEF", "realTeam": "ACHARYA ATTACKERS"},
    {"id": 32, "name": "VIVEK GAUTAM", "price": 12,
        "position": "DEF", "realTeam": "ACHARYA ATTACKERS"},
    {"id": 33, "name": "ZENITH SARU", "price": 18,
        "position": "DEF", "realTeam": "ZENITH ZEBRAS"},
    {"id": 34, "name": "ANUJ THAPA", "price": 15,
        "position": "DEF", "realTeam": "BENZE BULLS"},
    {"id": 35, "name": "ANUPAM BISTA", "price": 7,
        "position": "FWD", "realTeam": "BENZE BULLS"},
    {"id": 36, "name": "TASHI SHERPA", "price": 10,
        "position": "FWD", "realTeam": "BENZE BULLS"},
]
...
if 'show_captain_select' not in st.session_state:
    st.session_state.show_captain_select = False
if 'team_players' not in st.session_state:
    st.session_state.team_players = []

# Check captain status
all_selected = st.session_state.selected_gk + \
    st.session_state.selected_fwd + st.session_state.selected_def
...
with col1:
    ...
    new_gk = st.multiselect(
        "GK", gk_options, default=st.session_state.selected_gk, max_selections=1)
...
with col2:
    ...
    for p in PLAYERS:
        if p['position'] == 'FWD' and not (p.get('iscaptain', False) and has_captain_selected):
            fwd_options.append(
                f"{p['name']} (₹{p['price']}{' ⭐' if p.get('iscaptain', False) else ''})")

    st.caption(f"Max: {max_fwd}")
    new_fwd = st.multiselect(
        "FWD", fwd_options, default=st.session_state.selected_fwd, max_selections=max_fwd)
...
with col3:
    ...
    new_def = st.multiselect(
        "DEF", def_options, default=st.session_state.selected_def, max_selections=max_def)
...
def_fwd_total = len(st.session_state.selected_fwd) + \
    len(st.session_state.selected_def)
total_price = sum(int(p.split("₹")[1].split('⭐')[0].strip(")"))
                  for p in all_selected) if all_selected else 0
...
is_valid = (len(st.session_state.selected_gk) == 1 and def_fwd_total ==
            5 and len(all_selected) == 6 and total_price <= BUDGET)
...
if st.session_state.get('show_captain_select', False):
    ...
    selected_captain = st.selectbox(
        "**Captain** (2x points):", captain_options, key="captain_select")
    ...
    with col1:
        if st.button("✅ **SAVE TEAM + CAPTAIN**", type="primary"):
            try:
                ...
                positions_str = ", ".join([p['position']
                                          for p in team_players])
                real_teams_str = ", ".join(
                    [p['realTeam'] for p in team_players])
